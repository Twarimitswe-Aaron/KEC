  ...
  const mockCourses: Course[] = [
    {
      ...
      image: "https://i.pinimg.com/1200x/cb/a0/b8/cba0b89d2bf2d96a1ed26edb5849f804.jpg",
      students: [
        {
          id: 1,
          name: "Alice Johnson",
    ...
    { id: 3, image: "https://i.pinimg.com/1200x/cb/a0/b8/cba0b89d2bf2d96a1ed26edb5849f804.jpg", title: "UI/UX Design Fundamentals", students: [] },
    {
      id: 4,
       image: "https://i.pinimg.com/1200x/cb/a0/b8/cba0b89d2bf2d96a1ed26edb5849f804.jpg",
                    ...
                    <tbody className="divide-y divide-gray-200/50">
                      {course.students.map((student) => (
                        <React.Fragment key={student.id}>
                          <tr className="hover:bg-white/60 transition-all duration-200">
                            <td className="px-6 py-4">
                              <div className="flex items-center gap-3">
                                <div className="px-2 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full flex items-center justify-center text-white font-semibold">
                            ...
                            <td className="px-6 py-4">
                              <button
                                ...
                                onClick={() =>
                                  setViewStudentId(
                                    viewStudentId === student.id ? null : student.id
                                  )
                                }
                              >
