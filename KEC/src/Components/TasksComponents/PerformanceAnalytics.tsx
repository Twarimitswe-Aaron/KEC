    ...
    if (isOpen && onClose) {
      return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl max-w-7xl w-full max-h-[90vh] overflow-y-auto m-4">
            {/* Modal Header */}
      ...
      <div className="space-y-6 mt-8">
          ...
          <div className="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{courseAnalytics?.totalStudents || 0}</p>
              </div>
              <Users className="h-8 w-8 text-blue-600" />
            </div>
          </div>
          
          <div className="border border-gray-300 rounded-lg p-4 hover:border-green-400 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Average Performance</p>
                <p className="text-2xl font-bold text-gray-900">{courseAnalytics?.courseAverage?.toFixed(1) || '0.0'}%</p>
              </div>
              <TrendingUp className="h-8 w-8 text-green-600" />
            </div>
          </div>
          
          <div className="border border-gray-300 rounded-lg p-4 hover:border-red-400 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Students at Risk</p>
                <p className="text-2xl font-bold text-gray-900">{courseAnalytics?.studentsAtRisk || 0}</p>
              </div>
              <AlertTriangle className="h-8 w-8 text-red-600" />
            </div>
          </div>
          
          <div className="border border-gray-300 rounded-lg p-4 hover:border-yellow-400 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Completion Rate</p>
                <p className="text-2xl font-bold text-gray-900">{courseAnalytics?.completionRate?.toFixed(1) || '0.0'}%</p>
              </div>
        ...
        <div className="border border-gray-300 rounded-lg">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-gray-600 text-sm mt-1">All enrolled students with their marks, progress, and performance details</p>
          </div>
            ...
            <table className="w-full">
              <thead className="border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">Total Marks</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {courseAnalytics?.topPerformingStudents?.length ? (
                  courseAnalytics.topPerformingStudents.map((student, index) => (
                    <tr key={student.studentId} className="hover:bg-white transition-colors">
                      ...
                      <td className="px-6 py-4 text-center">
                        <div className="flex flex-col items-center">
                          <span className="text-lg font-bold text-gray-900">
                            {Math.round(student.overallAverage * student.totalAssignments / 100)}
                          </span>
                      ...
                      <td className="px-6 py-4 text-center">
                        <span className={`px-3 py-1 rounded-full text-sm font-bold ${
                          student.letterGrade === 'A' || student.letterGrade === 'A+' ? 'bg-green-100 text-green-800' :
                          student.letterGrade === 'B' || student.letterGrade === 'B+' ? 'bg-blue-100 text-blue-800' :
                          student.letterGrade === 'C' || student.letterGrade === 'C+' ? 'bg-yellow-100 text-yellow-800' :
                    ...
                    <td colSpan={7} className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-500 mb-4">
                          Student enrollment and performance data will appear here once available.
                        </p>
            ...
            <div className="flex justify-between items-center text-sm">
              <div className="flex items-center gap-6">
                <span>
                  ...
                  <span className="ml-2 font-bold">{courseAnalytics?.totalStudents || 0}</span>
                </span>
                <span>
                  <span className="font-medium text-gray-600">Class Average:</span>
                  <span className="ml-2 font-bold">{courseAnalytics?.courseAverage?.toFixed(1) || 0}%</span>
                </span>
                <span>
                  <span className="font-medium text-gray-600">At Risk:</span>
                  <span className="ml-2 font-bold text-red-600">{courseAnalytics?.studentsAtRisk || 0}</span>
                </span>
              </div>
              ...
              {Object.entries(courseAnalytics.gradeDistribution).map(([grade, count]) => (
                <div key={grade} className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className="w-8 text-center font-bold text-lg">{grade}</span>
                    <div className="flex-1 bg-gray-200 rounded-full h-3 min-w-[200px]">
                      <div 
                        ...
                        style={{ width: `${Math.max((count / (courseAnalytics?.totalStudents || 1)) * 100, 2)}%` }}
                      ></div>
                    </div>
      ...
      <div className="space-y-6 mt-8">
        <div className="bg-white rounded-lg p-6 border border-gray-200">
          ...
          <p className="text-gray-700 text-base">
            Comprehensive performance insights and trends across all course content for <span className="font-semibold">{selectedCourse.name}</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="border border-gray-300 rounded-lg p-4 hover:border-blue-400 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <h5 className="text-sm font-medium text-gray-600 mb-1">Total Students</h5>
                <span className="text-2xl font-bold text-gray-900">{courseAnalytics?.totalStudents || 0}</span>
              </div>
              <Users className="h-8 w-8 text-blue-600" />
            </div>
          </div>
          ...
          <div className="border border-gray-300 rounded-lg p-4 hover:border-green-400 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <h5 className="text-sm font-medium text-gray-600 mb-1">Average Performance</h5>
                <span className="text-2xl font-bold text-gray-900">{courseAnalytics?.courseAverage?.toFixed(1) || '0.0'}%</span>
              </div>
              <TrendingUp className="h-8 w-8 text-green-600" />
            </div>
          </div>
          ...
          <div className="border border-gray-300 rounded-lg p-4 hover:border-yellow-400 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <h5 className="text-sm font-medium text-gray-600 mb-1">Completion Rate</h5>
                <span className="text-2xl font-bold text-gray-900">{courseAnalytics?.completionRate?.toFixed(1) || '0.0'}%</span>
              </div>
              <Award className="h-8 w-8 text-yellow-600" />
            </div>
          </div>
          ...
          <div className="border border-gray-300 rounded-lg p-4 hover:border-red-400 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <h5 className="text-sm font-medium text-gray-600 mb-1">Students at Risk</h5>
                <span className="text-2xl font-bold text-gray-900">{courseAnalytics?.studentsAtRisk || 0}</span>
              </div>
              <AlertTriangle className="h-8 w-8 text-red-600" />
            </div>
          </div>
        ...
        <div className="border border-gray-300 rounded-lg">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-gray-600 text-sm mt-1">Detailed performance breakdown by lesson and assignment type</p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Lesson</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">Assignments</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">Avg Performance</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">Completion Rate</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">At Risk</th>
                ...
                {courseAnalytics?.lessonsAnalytics?.map((lesson) => (
                  <tr key={lesson.lessonId} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      ...
                      <div className="text-sm text-gray-500">{lesson.assignmentCount} total assignments</div>
                    </td>
                    <td className="px-6 py-4 text-center">
                    ...
                    <td className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center gap-1">
                        <span className={`px-4 py-2 rounded-full text-sm font-bold ${getGradeColor(lesson.averagePerformance)}`}>
                          {lesson.averagePerformance.toFixed(1)}%
                        </span>
                        <span className="text-xs text-gray-500">{getLetterGrade(lesson.averagePerformance)}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <span className="text-sm font-medium">{lesson.completionRate.toFixed(1)}%</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                        lesson.studentsAtRisk > 0 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                      }`}>
        ...
        <div className="border border-gray-300 rounded-lg">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-gray-600 text-sm mt-1">Complete overview of all students with quiz marks, totals, and rankings</p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">Total Score</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">Average</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">Grade</th>
                  <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">Status</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {courseAnalytics?.topPerformingStudents?.map((student, index) => (
                  <tr key={student.studentId} className={`hover:bg-gray-50 transition-colors ${
                    ...
                    <td className="px-6 py-4 text-center">
                      <span className={`px-3 py-1 rounded-full text-sm font-bold ${getGradeColor(student.overallAverage)}`}>
          ...
          <div className="p-6 bg-gray-50 border-t border-gray-200">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-bold">{courseAnalytics.completionRate?.toFixed(1) || 0}%</span>
              </div>
              <div>
                <span className="font-medium text-gray-600">Students at Risk:</span>
                <span className="ml-2 font-bold text-red-600">{courseAnalytics?.studentsAtRisk || 0}</span>
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-300 rounded-lg">
            ...
            <div className="p-6">
              <div className="space-y-4">
                {courseAnalytics?.topPerformingStudents?.slice(0, 5).map((student, index) => (
                  <div key={student.studentId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-medium text-gray-900">{student.name}</div>
                        <div className="text-sm text-gray-500">{student.assignmentsCompleted}/{student.totalAssignments} completed</div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="font-bold text-green-600">{student.overallAverage.toFixed(1)}%</div>
                      <div className="text-xs font-medium text-gray-600">{student.letterGrade}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div className="p-4 bg-green-50 rounded-lg border-l-4 border-green-400">
                  <h6 className="font-medium text-green-800 mb-1">Strong Areas</h6>
                  <p className="text-sm text-green-700">
                    {(() => {
                      ...
                      if (bestLesson) {
                        const percentage = bestLesson.averagePerformance.toFixed(1);
                ...
                <div className="p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-400">
                  <h6 className="font-medium text-yellow-800 mb-1">Areas for Improvement</h6>
                ...
                <div className="p-4 bg-blue-50 rounded-lg border-l-4 border-blue-400">
                  <h6 className="font-medium text-blue-800 mb-1">Course Progress</h6>
                  <p className="text-sm text-blue-700">
                    {courseAnalytics.completionRate 
                      ? `${courseAnalytics.completionRate.toFixed(1)}% overall completion rate`
