    ...
    <div className="" id="joinRwanda">
      ...
      <div className="w-full sm:flex hidden bg-white rounded-md shadow-[0_4px_4px_rgba(0,0,0,0.5)] overflow-hidden">
        <div className="w-[50%]">
          <img
            src="/images/join.png"
            className="object-cover rounded-md  shadow-[0_4px_4px_rgba(0,0,0,0.5)] overflow-hidden h-full w-full"
      ...
      {/* Mobile view */}
      <div className="flex rounded-2xl overflow-hidden sm:hidden relative w-full justify-center text-center items-center bg-[url('/images/join.png')] bg-cover">
