...
const NotFoundPage = () => {
    ...
    return (
        <motion.div
            ...
            className="font-robot w-full relative min-h-screen flex flex-col justify-between bg-[#F0F0F0]"
        >
            <Header />
            ...
            <div className="flex-grow w-full flex flex-col items-center justify-center font-sans px-4 py-20">
                <div className="flex flex-col items-center text-center max-w-lg gap-[25px]">
                    ...
                    <p className="text-[#707070] font-['Inter'] font-medium text-[1.1rem] max-w-md mx-auto tracking-[-0.035em] leading-[1.35em]">
                    ...
                    <AnimatedTextButton
                        ...
                        variant="secondary"
                        onClick={() => navigate("/")}
                        className="!ml-0 !text-lg !py-4 !pl-8 !pr-2 !bg-[#212121] shadow-[0px_7px_20px_0.5px_rgba(0,0,0,0.5)]"
                    />
                </div>
            </div>
