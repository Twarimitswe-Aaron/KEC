                    ...
                    <div className="max-w-4xl w-full flex flex-col gap-10 text-left">
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-base text-gray-600 leading-relaxed">
                                <span className="font-bold text-gray-900">Formix</span> respects your privacy and is committed to protecting the information you share with us. This Privacy Policy explains how we collect, use, and safeguard your data in connection with our design subscription service.
                            </p>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-base text-gray-600">We may collect the following types of information:</p>
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-base text-gray-600">We use your information to:</p>
                            <ul className="list-disc pl-5 space-y-2 text-base text-gray-600 marker:text-gray-500 leading-relaxed">
                        ...
                        <section className="space-y-4">
                            ...
                            <p className="text-base text-gray-600">You can:</p>
                            <ul className="list-disc pl-5 space-y-2 text-base text-gray-600 marker:text-gray-500 leading-relaxed">
